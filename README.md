...
Kurniawan adalah seorang Intelektual, Master ilmu komputer, Sarjana komputer, Filsuf, IT Security expert, IT Security Consultant, Senior Security Engineer, Progammer, IT Security reseacher, IT Security trainer.✍🏾<br />Komputer pribadi yang saya gunakan sehari-hari adalah komputer dengan menggunakan processor Intel Core i5 dengan distro Linux Mint 20.2.<br />
Semua server saya di internet yang saya handle, semua menggunakan Ubuntu Server. I love ubuntu server.✍🏾<br />
Untuk saat ini, di dunia programming, saya menyukai bash programming, python programming & PHP Programming, terlepas dari ada juga bahasa pemrograman lain yang digunakan seperti bahasa assembly.✍🏾<br />
